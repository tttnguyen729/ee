...
\begin{axis}
	...
	\node [color=blue, smooth, ultra thick, font=\Large] at (2,15) {$P_{1}(x)=1+x$};
    \node [color=blue, smooth, ultra thick, font=\Large] at (4,150) {$y=e^x$};
    \addplot[color=orange]{e^x};
...
\addplot[color=orange]{1+x+(x^2)/2};
	\node [color=blue, smooth, ultra thick, font=\Large] at (5,40) {$P_{2}(x)$};
    \node [color=blue, smooth, ultra thick, font=\Large] at (4,150) {$y=e^x$};
\end{axis}
\end{tikzpicture}
\end{figure}
...
\begin{axis}
	...
	\node [color=blue, smooth, ultra thick, font=\Large] at (5,15) {$P_{3}(x)$};
    \node [color=blue, smooth, ultra thick, font=\Large] at (4,150) {$y=e^x$};
    \addplot[color=orange]{e^x};
...
\node [color=blue, smooth, ultra thick, font=\Large] at (4,150) {$y=e^x$};
	\node [color=blue, smooth, ultra thick, font=\Large] at (4.5,15) {$P_{8}(x)$};
\end{axis}
\end{tikzpicture}
\end{figure}
...
\begin{axis}
    ...
    \addplot[color=orange]{4 * rad(atan(x))};
    \addplot[color=orange]{4 * (x - (x^3)/3)}; 
    \node [color=blue, smooth, ultra thick, font=\Large] at (3,-100) {$P_{1}(x)$};
    \node [color=blue, smooth, ultra thick, font=\Large] at (2,25) {$y=4\,tan^{-1}(x)$};
\end{axis}
\end{tikzpicture}
\end{figure}
...
\begin{axis}
	...
	\addplot[color=orange]{4 * (rad(atan(x)))};
	\addplot[color=orange]{4 * (x - (x^3)/3 + (x^5)/5 - (x^7)/7 + (x^9)/9)};
\node [color=blue, smooth, ultra thick, font=\Large] at (3,5 * 10^5) {$P_{4}(x)$};
    \node [color=blue, smooth, ultra thick, font=\Large] at (2.5,-11^5) {$y=4 \,tan^{-1}(x)$};
\end{axis}
\end{tikzpicture}
\end{figure}
...
\centering
	...
	\subfloat[error of two term approximation]{{
		\begin{tikzpicture}[scale=.75]
\begin{axis}
    [xmin=-5,
    ]
	\addplot[color=orange]{4 * (rad(atan(x))) - 4*(x + (x^3)/3)};
\end{axis}
\end{tikzpicture}
		}}%
	\qquad
	\subfloat[error of five term approximation] {{
		\begin{tikzpicture}[scale=.75]
\begin{axis}
    [xmin=-5,
    ]
	\addplot[color=orange]{4 * (rad(atan(x))) - 4 * (x + (x^3)/3 - (x^5)/5 + (x^7)/7 - (x^9)/9)};
\end{axis}
\end{tikzpicture}
		}}%
\end{figure}
